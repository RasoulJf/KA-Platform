    ...
    return (
        ...
        <div className={`absolute flex-column  right-0 w-[20%] h-screen transition duration-500 ease-in-out bg-[#F3F3F3] ${!open ? "translate-x-[70%]" : ""}`}>
            ...
            <div className={`h-[7vh] w-[30%] absolute transition duration-300 ${open ? 'hidden' : ""} flex text-end items-center text-sm transition duration-500  ${active == 1 ? "text-[#19A297] bg-linear-to-l font-semibold   from-[white] to-[#F3F3F3] " : "text-gray-400"}`}
                ...
                <div className={`h-[7vh] w-[30%] absolute transition duration-300 ${open ? 'hidden' : ""} top-16 flex justify-center items-center text-sm   ${active == 2 ? "text-[#19A297] font-semibold bg-linear-to-l  from-[white] to-[#F3F3F3] " : "text-gray-400"}`}
                ><Link onClick={()=>handleActive(2)} to={"/activities"} className='z-10 flex w-full justify-end mr-10 items-center gap-2'>
                        <LuMails />
                    </Link >
                ...
                ><Link onClick={()=>handleActive(3)} to={"/rewards"} className='z-10 flex w-full justify-end mr-10 items-center gap-2'>
                        <FaMedal />
                ...
                <div className={`h-[7vh] w-full relative flex justify-center items-center text-sm   ${active == 2 ? "text-[#19A297] font-semibold bg-linear-to-l  from-[white] to-[#F3F3F3] " : "text-gray-400"}`}
                ><Link onClick={()=>handleActive(2)} to={"/activities"} className='z-10 flex w-full justify-end mr-10 items-center gap-2'>
                        <h4>فعالیت‌ها</h4>
                        <LuMails />
                    </Link >
                ...
                <div className={`h-[7vh] w-full relative flex justify-center items-center text-sm   ${active == 4 ? "text-[#19A297] bg-linear-to-l font-semibold from-[white] to-[#F3F3F3] " : "text-gray-400"}`}
                ><Link onClick={()=>handleActive(4)} to={'/results'} className='z-10 flex w-full justify-end mr-10 items-center gap-2'>
                        <h4>جداول امتیازات</h4>
                        <MdBackupTable />
