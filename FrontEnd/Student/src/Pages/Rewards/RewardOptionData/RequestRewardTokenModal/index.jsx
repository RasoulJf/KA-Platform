  ...
  return (
    <div dir="rtl" className="fixed inset-0 bg-black/60 flex items-center justify-center z-[60] p-4 transition-opacity duration-300 ease-in-out">
      <div className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-md relative transform transition-all duration-300 ease-in-out scale-100">
        ...
        <div className="text-start mb-6 flex">
        ...
        {message && message.text && (
          <div
            className={`p-3 rounded-md text-sm text-start mb-4 font-medium ${
        ...
        {message?.type !== 'success' && (
          <form onSubmit={handleFormSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div id="staticTokenInfoModal" className="p-3 bg-gray-100 border border-gray-200 rounded-lg text-gray-700 text-sm text-start font-medium">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-[#19A297] focus:border-[#19A297] text-gray-800 text-sm text-start placeholder-gray-400 appearance-none"
